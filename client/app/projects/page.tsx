...
const projects = [
  ...
  },
  {
    ...
    status: "Live",
    title: "Automation",
    desc: "Build an automated registration system in n8n featuring email validation, duplicate checks in Google Sheets, automated applicant priority scoring via Gemini AI, custom JavaScript data parsing, and dual-channel notifications through Gmail and Telegram Bot API",
    tech: [
      "n8n",
      "Gemini AI API",
      "Webhooks",
    ...
    github: "https://github.com/BimaPanjiWijaya/Automation",
    live: "https://github.com/BimaPanjiWijaya/Automation",
  },
  {
    num: "03",
    year: "May 2026",
